...
Consumes the pure SD escalation rule engine (app.services.escalation.rules.escalation_for)
to annotate overdue reminders with deterministic escalation stages and roles.
