"""Unit tests for app/services/triage/rules.py -- SD-owned deterministic triage engine.

Pure unit tests: no database, no network calls, no app startup.
Executed with pytest --noconftest to run in isolation without requiring
...
from app.services.triage.rules import VERSION, evaluate_triage
