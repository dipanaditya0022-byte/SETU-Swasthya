...
Tests:
- ml.escalation.rules.escalation_for() (moved from
  backend/app/services/escalation/ as part of the ml/ integration --
  see ml/README.md; this file's own conftest.py puts backend/ on
  sys.path so the adapter/factory/port imports below still resolve)
...
from ml.escalation.rules import VERSION, escalation_for
...
def test_engine_source_purity_check():
    import ml.escalation.rules as rules_mod
